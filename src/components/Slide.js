...
function Slide(props) {
    ...
    //let { slideColor } = preso.presentation.presentationSlideGroups[1].groupSlides[0];

    const slideColor = '0.5 0 0.5 1';
    const slideText ='BLESS THE LORD, OH MY SOUL\nOH MY SOUL, WORSHIP HIS HOLY NAME';
